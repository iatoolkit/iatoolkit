...
class TestToolService:
    ...
    def test_handle_wiki_search_tool_delegates_to_service(self):
        ...
        result = self.service._handle_wiki_search_tool(
            company_short_name="my_company",
            wiki_key="sales",
    ...
    def test_handle_wiki_get_page_tool_delegates_to_service(self):
        ...
        result = self.service._handle_wiki_get_page_tool(
            company_short_name="my_company",
            wiki_key="sales",
            path="pricing.md",
            allowed_wiki_keys=["sales"],
    ...
    def test_create_http_tool_bridge_transport_success(self):
        self.mock_llm_query_repo.get_tool_definition.return_value = None

        mock_created = MagicMock(spec=Tool)
        mock_created.to_dict.return_value = {"name": "http_orders_bridge"}
        self.mock_llm_query_repo.add_tool.return_value = mock_created
        ...
        assert result["name"] == "http_orders_bridge"
        args = self.mock_llm_query_repo.add_tool.call_args[0][0]
    ...
    def test_create_http_tool_bridge_transport_requires_target_not_url(self):
        self.mock_llm_query_repo.get_tool_definition.return_value = None
    ...
    def test_create_http_tool_rejects_invalid_transport(self):
        self.mock_llm_query_repo.get_tool_definition.return_value = None

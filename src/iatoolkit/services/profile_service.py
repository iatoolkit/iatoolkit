...
class ProfileService:
    ...
    def list_api_keys(self, company_short_name: str) -> Dict:
        ...
        api_keys = self.profile_repo.get_api_keys_by_company(company)
    ...
    def get_api_key(self, company_short_name: str, api_key_id: int) -> Dict:
        ...
        api_key = self.profile_repo.get_api_key_by_id(company, api_key_id)
        if not api_key:
    ...
    def create_api_key_entry(self, company_short_name: str, key_name: str) -> Dict:
        ...
        existing = self.profile_repo.get_api_key_by_name(company, key_name)
        if existing:
        ...
        created = self.profile_repo.create_api_key(api_key)
    ...
    def update_api_key_entry(self,
        ...
        updated = self.profile_repo.update_api_key(api_key)
    ...
    def delete_api_key_entry(self, company_short_name: str, api_key_id: int) -> Dict:
        ...
        self.profile_repo.delete_api_key(api_key)
